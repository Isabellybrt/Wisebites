...
export function Footer() {
  return (
    <footer className="bg-white border-t border-gray-200">
      <div className="wisebites-container py-8 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="mt-4 text-sm text-gray-600">
              Plataforma de acompanhamento nutricional que conecta nutricionistas e pacientes,
              facilitando o acompanhamento de dietas e planos alimentares de maneira fácil e intuitiva.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link to="/reset-password" className="text-sm text-gray-600 hover:text-primary">
                  Esqueci a senha
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-sm text-gray-500 md:mt-0 md:order-1">
            &copy; {new Date().getFullYear()} WiseBites. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
